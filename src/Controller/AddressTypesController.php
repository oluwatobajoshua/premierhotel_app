...
class AddressTypesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->AddressTypes->save($addressType)) {
                $this->Flash->success(__('The {0} has been saved.', 'Address Type'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__('The {0} could not be saved. Please, try again.', 'Address Type'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->AddressTypes->delete($addressType)) {
            $this->Flash->success(__('The {0} has been deleted.', 'Address Type'));
        } else {
            $this->Flash->error(__('The {0} could not be deleted. Please, try again.', 'Address Type'));
        }
