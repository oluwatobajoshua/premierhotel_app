      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= $local->has('state') ? $this->Html->link($local->state->name, ['controller' => 'States', 'action' => 'view', $local->state->id]) : '' ?></dd>
            <dt scope="row"><?= __('Name') ?></dt>
            <dd><?= h($local->name) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($local->id) ?></dd>
          </dl>
        </div>
      </div>
    </div>
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
              <tr>
                    ...
                    <th scope="col"><?= __('Reporting To') ?></th>
                    <th scope="col"><?= __('Name Of Spouse') ?></th>
