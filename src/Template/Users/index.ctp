...
<section class="content-header">
  <h1>
    ...
    <div class="pull-right"><?php echo $this->Html->link(__('New'), ['action' => 'add'], ['class'=>'btn btn-success btn-xs']) ?>| <?= $this->Form->postLink(__('Add Users'), ['action' => 'addUsers'], ['confirm' => __('You are about to add Many User'), 'class'=>'btn btn-success btn-xs']) ?></div>
  </h1>
</section>
            ...
            <tbody>
              <?php foreach ($users as $user): ?>
                <tr>
                  ...
                  <td><?= $user->has('role') ? $this->Html->link($user->role->name, ['controller' => 'Employees', 'action' => 'view', $user->role->id]) : '' ?></td>
