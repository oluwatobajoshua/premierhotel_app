...
<section class="content-header">
  <h1>
    Accounts managed by <?php echo $user->username ?>
    <?php if(@$cashier): ?>
        <div class="pull-right"><?php echo $this->Html->link(__('New'), ['action' => 'add', $co], ['class'=>'btn btn-success btn-xs']) ?></div>
    <?php endif ?>
  </h1>
</section>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                  ...
                  <th scope="col"><?= $this->Paginator->sort('user_id', 'Credit Officer') ?></th>
