...
class CommentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('comment_from')
            ->requirePresence('comment_from', 'create')
            ->notEmptyString('comment_from');

        $validator
            ->integer('comment_to')
            ->requirePresence('comment_to', 'create')
            ->notEmptyString('comment_to');

        $validator
            ->integer('comment_reply_to')
            ->requirePresence('comment_reply_to', 'create')
            ->notEmptyString('comment_reply_to');
