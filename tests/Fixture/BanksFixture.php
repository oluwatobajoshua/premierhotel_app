...
class BanksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'branch' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'code' => 'Lorem ip',
                'branch' => 'Lorem ip',
                'created' => '2019-12-29 16:51:35',
                'modified' => '2019-12-29 16:51:35'
            ],
        ];
        parent::init();
    }
