...
class WorkDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'job_class' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'end_date' => '2022-01-07',
                'created' => '2022-01-07 18:13:48',
                'modified' => '2022-01-07 18:13:48'
            ],
        ];
        parent::init();
    }
